...
- (void)updateAppearance {
    ...
    STPTheme *navBarTheme = self.navigationController.navigationBar.stp_theme;
    if ( navBarTheme == nil ) {
        navBarTheme = self.theme;
        self.navigationController.navigationBar.stp_theme = navBarTheme;
    }
